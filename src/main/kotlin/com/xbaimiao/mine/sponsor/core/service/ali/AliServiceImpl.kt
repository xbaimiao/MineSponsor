...
class AliServiceImpl(
    ...
    override fun alipay(orderName: String, player: String, amount: Double): Response? {
        val orderId = createOutTradeNo()
        val url =
            "$url/api/$version/create?apiKey=${apiKey}&desc=${orderName}&type=alipay&money=$amount&player=$player&orderId=$orderId"
